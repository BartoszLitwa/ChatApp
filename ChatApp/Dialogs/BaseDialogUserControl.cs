    ...
    public class BaseDialogUserControl : UserControl
    {
        ...
        public Task ShowDialog<T>(T viewModel) where T : BaseDialogViewModel
        {
            ...
            Application.Current.Dispatcher.Invoke(() =>
            {
                try
                {
                    // Match controls expected sizes t the dialog windows view model
                    ...
                    // Setup this control data context binding to thew view model
                    DataContext = viewModel;

                    // Show in the centre if the parent
